...
<link href="<?= base_url('assets/gentelella-master') ?>/vendors/datatables.net-scroller-bs/css/scroller.bootstrap.min.css" rel="stylesheet">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                  ...
                  <div class="x_content">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                      <div class="x_panel">
                        <div class="x_title">
                          <h2>Profile Management <small>Peraturan Reformasi Birokrasi LAPAN</small></h2>
                        ...
                        <div class="x_content">
                          ...
                          <table id="datatable" class="table table-striped table-bordered">
                            ...
                            <?php foreach ($Peraturan_rb as $peraturan_rb): ?>
                              ...
                              <tr>
                                <td><?= $No++; ?></td>
                                <td><?= $peraturan_rb->title ?></td>
                                <td><?= $peraturan_rb->isi ?></td>
                                <td>
                                  <a href="#edit" onclick="retrieveData('<?= $peraturan_rb->id_peraturan_rb ?>')" data-toggle="modal" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> Edit </a>
                                  <a href="#delete" onclick="deleteData('<?= $peraturan_rb->id_peraturan_rb ?>')" data-toggle="modal" class="btn btn-danger btn-xs"><i class="fa fa-trash-o" > Delete </i></a>
                                </td>
                              </tr>
                    ...
                    <?= form_open('editor/peraturanrb-management') ?>
                      <div class="modal-dialog modal-sm">
                        <div class="modal-content">
                          ...
                          <div class="modal-footer">
                            <input type="hidden" name="id_peraturan_rb_del" id="id_peraturan_rb_del" value="">
                    ...
                    <?= form_open('editor/peraturanrb-management',array('class' => 'form-horizontal')) ?>
                          ...
                          <div class="modal-body">
                            <div class="form-group">
                              ...
                              <div class="col-md-6 col-sm-6 col-xs-12">
                                ...
                                <input type="hidden" id="id_peraturan_rb_baru" name="id_peraturan_rb_baru" required="required" class="form-control col-md-7 col-xs-12">
                              </div>
                            </div>
                            <div class="form-group">
                              <label class="control-label col-md-3 col-sm-3 col-xs-12" >Isi <span class="required">*</span>
    ...
    function retrieveData(id_peraturan_rb) {
        $.get('<?= base_url('index.php/editor/peraturanrb-management') ?>' + '/' + id_peraturan_rb, function(data) {
          data = JSON.parse(data);
          $('#id_peraturan_rb_baru').val(data.id_peraturan_rb);
          $('#title_baru').val(data.title);
          tinymce.EditorManager.get('isi_baru').setContent(data.isi);
        });
      }

      function deleteData(id_peraturan_rb){
          $('#id_peraturan_rb_del').val(id_peraturan_rb); 
      }
