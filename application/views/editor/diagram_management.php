...
<link href="<?= base_url('assets/gentelella-master') ?>/vendors/datatables.net-scroller-bs/css/scroller.bootstrap.min.css" rel="stylesheet">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                  ...
                  <div class="x_content">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                      <div class="x_panel">
                        <div class="x_title">
                          <h2>Diagram Management <small>Diagram Capaian</small></h2>
                          ...
                          <table id="datatable" class="table table-striped table-bordered">
                            ...
                            <?php foreach ($Pencapaian as $pencapaian): ?>
                              ...
                              <tr>
                                ...
                                <td><?= $pencapaian->nilai ?></td>
                                <td>
                                  <a href="#edit" onclick="retrieveData('<?= $pencapaian->id_pencapaian ?>')" data-toggle="modal" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> Edit </a>
                                  <a href="#delete" onclick="deleteData('<?= $pencapaian->id_pencapaian ?>')" data-toggle="modal" class="btn btn-danger btn-xs"><i class="fa fa-trash-o" > Delete </i></a>
                                </td>
                              </tr>
                    ...
                    <?= form_open('editor/diagram-management') ?>
                      <div class="modal-dialog modal-sm">
                        <div class="modal-content">
                          ...
                          <div class="modal-footer">
                            <input type="hidden" name="id_pencapaian_del" id="id_pencapaian_del" value="">
                    ...
                    <?= form_open('editor/diagram-management',array('class' => 'form-horizontal')) ?>
                        ...
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="number" id="nilai" name="nilai" required="required" class="form-control col-md-7 col-xs-12" value="">
                              </div>
                            </div>
                          <div class="modal-footer">
                        ...
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            <div class="form-group">
                              ...
                              <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" id="nama_baru" name="nama_baru" required="required" class="form-control col-md-7 col-xs-12" value="">
                                <input type="hidden" id="id_pencapaian_baru" name="id_pencapaian_baru" required="required" class="form-control col-md-7 col-xs-12">
                              </div>
                            </div>
                            <div class="form-group">
                              <label class="control-label col-md-3 col-sm-3 col-xs-12" >Nilai <span class="required">*</span>
                              ...
                              <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="number" id="nilai_baru" name="nilai_baru" required="required" class="form-control col-md-7 col-xs-12" value="">
                              </div>
                            </div>
                          <div class="modal-footer">
                            <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
    ...
    function retrieveData(id_pencapaian) {
        $.get('<?= base_url('index.php/editor/diagram-management') ?>' + '/' + id_pencapaian, function(data) {
          data = JSON.parse(data);
          $('#id_pencapaian_baru').val(data.id_pencapaian);
          $('#nama_baru').val(data.nama);
          $('#nilai_baru').val(data.nilai);
        });
      }

    function deleteData(id_pencapaian){
        $('#id_pencapaian_del').val(id_pencapaian); 
    }
