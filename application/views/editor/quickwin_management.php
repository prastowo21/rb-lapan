...
<link href="<?= base_url('assets/gentelella-master') ?>/vendors/bootstrap-imageupload/css/fileinput.min.css" rel="stylesheet">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                  ...
                  <div class="x_content">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                      <div class="x_panel">
                        <div class="x_title">
                          <h2>Profile Management <small>Quickwin</small></h2>
                        ...
                        <div class="x_content">
                          ...
                          <table id="datatable" class="table table-striped table-bordered">
                            ...
                            <?php foreach ($quickwins as $quickwin): ?>
                              ...
                              <tr>
                                <td><?= $No++; ?></td>
                                <td><?= $quickwin->title ?></td>
                                <td><?= $quickwin->isi ?></td>
                                <td>
                                  <a href="<?= base_url() ?>doc_file/quickwin/<?= $quickwin->dokumen ?>" target="_blank"><?= $quickwin->dokumen ?></a>
                                </td>
                                <td>
                                  <a href="#edit" onclick="retrieveData('<?= $quickwin->id_quickwin ?>')" data-toggle="modal" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> Edit </a>
                                  <a href="#delete" onclick="deleteData('<?= $quickwin->id_quickwin ?>')" data-toggle="modal" class="btn btn-danger btn-xs"><i class="fa fa-trash-o" > Delete </i></a>
                                </td>
                              </tr>
                    ...
                    <?= form_open('editor/quickwin-management') ?>
                      <div class="modal-dialog modal-sm">
                        <div class="modal-content">
                          ...
                          <div class="modal-footer">
                            <input type="hidden" name="id_quickwin_del" id="id_quickwin_del" value="">
                    ...
                    <?= form_open_multipart('editor/quickwin-management',array('class' => 'form-horizontal')) ?>
                          ...
                          <div class="modal-body">
                            <div class="form-group">
                              ...
                              <div class="col-md-6 col-sm-6 col-xs-12">
                                ...
                                <input type="hidden" id="id_quickwin_baru" name="id_quickwin_baru" required="required" class="form-control col-md-7 col-xs-12">
                              </div>
                            </div>
                            <div class="form-group">
                              <label class="control-label col-md-3 col-sm-3 col-xs-12" >Isi <span class="required">*</span>
    ...
    function retrieveData(id_quickwin) {
        $.get('<?= base_url('index.php/editor/quickwin-management') ?>' + '/' + id_quickwin, function(data) {
          data = JSON.parse(data);
          $('#id_quickwin_baru').val(data.id_quickwin);
          $('#title_baru').val(data.title);
          tinymce.EditorManager.get('isi_baru').setContent(data.isi);
        });
      }

      function deleteData(id_quickwin){
          $('#id_quickwin_del').val(id_quickwin); 
      }
