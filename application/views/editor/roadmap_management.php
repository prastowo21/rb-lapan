...
<link href="<?= base_url('assets/gentelella-master') ?>/vendors/bootstrap-imageupload/css/fileinput.min.css" rel="stylesheet">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                  ...
                  <div class="x_content">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                      <div class="x_panel">
                        <div class="x_title">
                          <h2>Profile Management <small>Roadmap</small></h2>
                          ...
                          <table id="datatable" class="table table-striped table-bordered">
                            ...
                            <?php foreach ($Roadmap as $roadmap): ?>
                              ...
                              <tr>
                                ...
                                <td><?= $roadmap->isi ?></td>
                                <td>
                                  <a href="<?= base_url() ?>doc_file/roadmap/<?= $roadmap->dokumen ?>" target="_blank"><?= $roadmap->dokumen ?></a>
                                </td>
                                <td>
                                  <a href="#edit" onclick="retrieveData('<?= $roadmap->id_roadmap ?>')" data-toggle="modal" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> Edit </a>
                                  <a href="#delete" onclick="deleteData('<?= $roadmap->id_roadmap ?>')" data-toggle="modal" class="btn btn-danger btn-xs"><i class="fa fa-trash-o" > Delete </i></a>
                                </td>
                              </tr>
                    ...
                    <?= form_open('editor/roadmap-management') ?>
                      <div class="modal-dialog modal-sm">
                        <div class="modal-content">
                          ...
                          <div class="modal-footer">
                            <input type="hidden" name="id_roadmap_del" id="id_roadmap_del" value="">
                    ...
                    <?= form_open_multipart('editor/roadmap-management',array('class' => 'form-horizontal')) ?>
                          ...
                          <div class="modal-body">
                            <div class="form-group">
                              ...
                              <div class="col-md-6 col-sm-6 col-xs-12">
                                ...
                                <input type="hidden" id="id_roadmap_baru" name="id_roadmap_baru" required="required" class="form-control col-md-7 col-xs-12">
                              </div>
                            </div>
                            <div class="form-group">
                              <label class="control-label col-md-3 col-sm-3 col-xs-12" >Isi <span class="required">*</span>
    ...
    $(document).ready(function() {
      tinymce.init({
        ...
        toolbar1: 'undo redo | insert | table | fontsizeselect | bold italic | alignleft aligncenter alignright alignjustify | bullist numlist outdent indent | link image',
    ...
    function retrieveData(id_roadmap) {
        $.get('<?= base_url('index.php/editor/roadmap-management') ?>' + '/' + id_roadmap, function(data) {
          data = JSON.parse(data);
          $('#id_roadmap_baru').val(data.id_roadmap);
          $('#title_baru').val(data.title);
          tinymce.EditorManager.get('isi_baru').setContent(data.isi);
          // $('#summernote1').summernote('code', data.isi);
        });
      }
      ...
      var dokumen = new FormData($('#dokumen')[0].files[0]);
      //var deskripsi_berita = $('#summernote').summernote('code');

          $.ajax({
            url: '<?= base_url('index.php/editor/roadmap-management') ?>',
            type: 'POST',
            data: {
              tambah: true,
              title,
      ...
      function editBerita(){
        var title_baru = $('#title_baru').val();
        var id_roadmap_baru = $('#id_roadmap_baru').val();
        var isi_baru = $('#summernote1').summernote('code');
        var dokumen_baru = $('#dokumen_baru').val();
      ...
      function deleteData(id_roadmap){
          $('#id_roadmap_del').val(id_roadmap); 
      }
