...
<link href="<?= base_url('assets/gentelella-master') ?>/vendors/datatables.net-scroller-bs/css/scroller.bootstrap.min.css" rel="stylesheet">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                  ...
                  <div class="x_content">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                      <div class="x_panel">
                        <div class="x_title">
                          <h2>Profile Management <small>Visi dan Misi</small></h2>
                          ...
                          <table id="datatable" class="table table-striped table-bordered">
                            ...
                            <?php foreach ($vimis as $vimi): ?>
                              ...
                              <tr>
                                ...
                                <td><?= $vimi->isi ?></td>
                                <td>
                                  <a href="#edit" onclick="retrieveData('<?= $vimi->id_vimi ?>')" data-toggle="modal" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> Edit </a>
                                  <a href="#delete" onclick="deleteData('<?= $vimi->id_vimi ?>')" data-toggle="modal" class="btn btn-danger btn-xs"><i class="fa fa-trash-o" > Delete </i></a>
                                </td>
                              </tr>
                    ...
                    <?= form_open('editor/vimi-management') ?>
                      <div class="modal-dialog modal-sm">
                        <div class="modal-content">
                          ...
                          <div class="modal-footer">
                            <input type="hidden" name="id_vimi_del" id="id_vimi_del" value="">
                    ...
                    <?= form_open('editor/vimi-management',array('class' => 'form-horizontal')) ?>
                          ...
                          <div class="modal-body">
                            <div class="form-group">
                              ...
                              <div class="col-md-6 col-sm-6 col-xs-12">
                                ...
                                <input type="hidden" id="id_vimi_baru" name="id_vimi_baru" required="required" class="form-control col-md-7 col-xs-12">
                              </div>
                            </div>
                            <div class="form-group">
                              <label class="control-label col-md-3 col-sm-3 col-xs-12" >Isi <span class="required">*</span>
    ...
    function retrieveData(id_vimi) {
        $.get('<?= base_url('index.php/editor/vimi-management') ?>' + '/' + id_vimi, function(data) {
          data = JSON.parse(data);
          $('#id_vimi_baru').val(data.id_vimi);
          $('#title_baru').val(data.title);
          tinymce.EditorManager.get('isi_baru').setContent(data.isi);
        });
      }

      function deleteData(id_vimi){
          $('#id_vimi_del').val(id_vimi); 
      }
