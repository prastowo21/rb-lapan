...
<link href="<?= base_url('assets/gentelella-master') ?>/vendors/bootstrap-imageupload/css/fileinput.min.css" rel="stylesheet">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                  ...
                  <div class="x_content">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                      <div class="x_panel">
                        <div class="x_title">
                          <h2>IKM Management <small>Indeks Kepuasan Masyarakat di LAPAN</small></h2>
                          ...
                          <table id="datatable" class="table table-striped table-bordered">
                            ...
                            <?php foreach ($IKM as $ikm): ?>
                              ...
                              <tr>
                                ...
                                <td><?= $ikm->tahun ?></td>
                                <td>
                                  <a href="<?= base_url() ?>doc_file/ikm/<?= $ikm->isi ?>" target="_blank"><?= $ikm->isi ?></a>
                                </td>
                                <td>
                                  <?php $id_role = $this->user_m->get_row(array('id_user' => $ikm->id_user))->id_role ; ?>
                                  <?php if ($id_role == 1): ?>
                                    Diunggah oleh <?= $this->admin_m->get_row(array('id_user' => $ikm->id_user))->nama ?> (Admin)
                                  <?php elseif ($id_role == 2): ?>
                                    Diunggah oleh <?= $this->editor_m->get_row(array('id_user' => $ikm->id_user))->nama ?> (Editor)
                                  <?php endif; ?>
                                </td>
                                <td><?= $ikm->tanggal ?></td>
                                <td>
                                  <a href="#edit" onclick="retrieveData('<?= $ikm->id_ikm ?>');" data-toggle="modal" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> Edit </a>
                                  <a href="#delete" onclick="deleteData('<?= $ikm->id_ikm ?>');" data-toggle="modal" class="btn btn-danger btn-xs"><i class="fa fa-trash-o" ></i> Delete </a>
                                </td>
                              </tr>
                    ...
                    <?= form_open('editor/ikm-management') ?>
                      <div class="modal-dialog modal-sm">
                        <div class="modal-content">
                          ...
                          <div class="modal-footer">
                            <input type="hidden" name="id_ikm_del" id="id_ikm_del" value="">
                    ...
                    <?= form_open_multipart('editor/ikm-management',array('class' => 'form-horizontal')) ?>
                          ...
                          <div class="modal-body">
                            <div class="form-group">
                              ...
                              <div class="col-md-6 col-sm-6 col-xs-12">
                                ...
                                <input type="hidden" id="id_ikm_baru" name="id_ikm_baru" required="required" class="form-control col-md-7 col-xs-12">
                              </div>
                            </div>
                            <div class="form-group">
                              <label class="control-label col-md-3 col-sm-3 col-xs-12" >Tahun <span class="required">*</span>
    ...
    function retrieveData(id_ikm) {
        $.get('<?= base_url('index.php/editor/ikm-management') ?>' + '/' + id_ikm, function(data) {
          data = JSON.parse(data);
          $('#id_ikm_baru').val(data.id_ikm);
          $('#title_baru').val(data.title);
          $('#tahun_baru').val(data.tahun);
        });
      }

      function deleteData(id_ikm){
          $('#id_ikm_del').val(id_ikm); 
      }
