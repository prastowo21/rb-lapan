...
<link href="<?= base_url('assets/gentelella-master') ?>/vendors/datatables.net-scroller-bs/css/scroller.bootstrap.min.css" rel="stylesheet">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                  ...
                  <div class="x_content">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                      <div class="x_panel">
                        <div class="x_title">
                          <h2>Profile Management <small>Sasaran dan Indikator Keberhasilan</small></h2>
                          ...
                          <table id="datatable" class="table table-striped table-bordered">
                            ...
                            <?php foreach ($sasarans as $sasaran): ?>
                              ...
                              <tr>
                                ...
                                <td><?= $sasaran->isi ?></td>
                                <td>
                                  <a href="#edit" onclick="retrieveData('<?= $sasaran->id_sasaran ?>')" data-toggle="modal" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> Edit </a>
                                  <a href="#delete" onclick="deleteData('<?= $sasaran->id_sasaran ?>')" data-toggle="modal" class="btn btn-danger btn-xs"><i class="fa fa-trash-o" > Delete </i></a>
                                </td>
                              </tr>
                    ...
                    <?= form_open('editor/sasaran-management') ?>
                      <div class="modal-dialog modal-sm">
                        <div class="modal-content">
                          ...
                          <div class="modal-footer">
                            <input type="hidden" name="id_sasaran_del" id="id_sasaran_del" value="">
                    ...
                    <?= form_open('editor/sasaran-management',array('class' => 'form-horizontal')) ?>
                          ...
                          <div class="modal-body">
                            <div class="form-group">
                              ...
                              <div class="col-md-6 col-sm-6 col-xs-12">
                                ...
                                <input type="hidden" id="id_sasaran_baru" name="id_sasaran_baru" required="required" class="form-control col-md-7 col-xs-12">
                              </div>
                            </div>
                            <div class="form-group">
                              <label class="control-label col-md-3 col-sm-3 col-xs-12" >Isi <span class="required">*</span>
    ...
    function retrieveData(id_sasaran) {
        $.get('<?= base_url('index.php/editor/sasaran-management') ?>' + '/' + id_sasaran, function(data) {
          data = JSON.parse(data);
          $('#id_sasaran_baru').val(data.id_sasaran);
          $('#title_baru').val(data.title);
          tinymce.EditorManager.get('isi_baru').setContent(data.isi);
        });
      }

      function deleteData(id_sasaran){
          $('#id_sasaran_del').val(id_sasaran); 
      }
