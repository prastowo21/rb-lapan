...
<link href="<?= base_url('assets/gentelella-master') ?>/vendors/bootstrap-imageupload/css/fileinput.min.css" rel="stylesheet">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                  ...
                  <div class="x_content">
                    ...
                    <?= form_open('admin/penataan-peraturan-uu-management') ?>
                    ...
                    <?= form_open_multipart('admin/penataan-peraturan-uu-management',array('class' => 'form-horizontal')) ?>
    ...
    function retrieveData(id_penataan_peraturan_uu) {
        $.get('<?= base_url('index.php/admin/penataan-peraturan-uu-management') ?>' + '/' + id_penataan_peraturan_uu, function(data) {
