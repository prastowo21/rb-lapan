...
<link href="<?= base_url('assets/gentelella-master') ?>/vendors/bootstrap-imageupload/css/fileinput.min.css" rel="stylesheet">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                  ...
                  <div class="x_content">
                    ...
                    <?= form_open('admin/ikm-management') ?>
                    ...
                    <?= form_open_multipart('admin/ikm-management',array('class' => 'form-horizontal')) ?>
    ...
    function retrieveData(id_ikm) {
        $.get('<?= base_url('index.php/admin/ikm-management') ?>' + '/' + id_ikm, function(data) {
