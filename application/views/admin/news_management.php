...
<div class="right_col" role="main">
  <div class="clearfix"></div>
                  ...
                  <div class="x_content">
                    ...
                    <?= form_open('admin/news-management') ?>
                    ...
                    <?= form_open_multipart('admin/news-management',array('class' => 'form-horizontal')) ?>
    ...
    function dataBerita(id_berita, id_user) {
        $.get('<?= base_url('index.php/admin/news-management') ?>' + '/' + id_berita + '/' + id_user, function(data) {
