...
<link href="<?= base_url('assets/gentelella-master') ?>/vendors/datatables.net-scroller-bs/css/scroller.bootstrap.min.css" rel="stylesheet">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                  ...
                  <div class="x_content">
                    ...
                    <?= form_open('admin/sasaran-management') ?>
                    ...
                    <?= form_open('admin/sasaran-management',array('class' => 'form-horizontal')) ?>
    ...
    function retrieveData(id_sasaran) {
        $.get('<?= base_url('index.php/admin/sasaran-management') ?>' + '/' + id_sasaran, function(data) {
