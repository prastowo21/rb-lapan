...
<link href="<?= base_url('assets/gentelella-master') ?>/vendors/datatables.net-scroller-bs/css/scroller.bootstrap.min.css" rel="stylesheet">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                  ...
                  <div class="x_content">
                    ...
                    <?= form_open('admin/diagram-management') ?>
                    ...
                    <?= form_open('admin/diagram-management',array('class' => 'form-horizontal')) ?>
    ...
    function retrieveData(id_pencapaian) {
        $.get('<?= base_url('index.php/admin/diagram-management') ?>' + '/' + id_pencapaian, function(data) {
