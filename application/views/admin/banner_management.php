...
<div class="right_col" role="main">
  <div class="clearfix"></div>
                  ...
                  <div class="x_content">
                    ...
                    <?= form_open('admin/banner-management') ?>
                    ...
                    <?= form_open_multipart('admin/banner-management',array('class' => 'form-horizontal')) ?>
    ...
    function retrieveBanner(id_banner) {
      $.get('<?= base_url('index.php/admin/banner-management') ?>' + '/' + id_banner, function(data) {
