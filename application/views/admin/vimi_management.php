...
<link href="<?= base_url('assets/gentelella-master') ?>/vendors/datatables.net-scroller-bs/css/scroller.bootstrap.min.css" rel="stylesheet">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                  ...
                  <div class="x_content">
                    ...
                    <?= form_open('admin/vimi-management') ?>
                    ...
                    <?= form_open('admin/vimi-management',array('class' => 'form-horizontal')) ?>
    ...
    function retrieveData(id_vimi) {
        $.get('<?= base_url('index.php/admin/vimi-management') ?>' + '/' + id_vimi, function(data) {
