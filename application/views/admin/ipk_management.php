          ...
          <div class="">
            ...
            <div class="row">
              ...
              <div id="delete" class="modal fade bs-example-modal-sm" tabindex="-1" role="dialog" aria-hidden="true">
                <?= form_open('admin/ipk-management/') ?>
    ...
    <script type="text/javascript">
      $(document).ready(function() {
        ...
        var table_responden =  $('#datatables').DataTable({
            ...
            "paging": true,
            deferRender: true,
            "sAjaxSource":'<?= base_url('index.php/admin/getDataResponden') ?>',
            "columns": [
            null,
            null,
            null,
        ...
        var table_published =  $('#datapublished').DataTable({
            ...
            "paging": true,
            deferRender: true,
            "sAjaxSource":'<?= base_url('index.php/admin/getDataPublished') ?>',
            "columns": [
            null,
            null,
            null,
      ...
      function ipk(){
        $.getJSON("<?= base_url('index.php/admin/data_ipk') ?>", function(data) {
          // $('#ipk').remove();
          $('#ipk').html(data.ipk);
          $('#ipk1').html(data.ipk);
      ...
      function publish_button(id){
        ...
        $.ajax({
           type: "POST",
           url: '<?= base_url('index.php/admin/publishDataResponden') ?>',
           data: data,
           success: function(){
      ...
      $('#btn-simpan').click(function(){
        ...
        $.ajax({
          url: '<?= base_url('index.php/admin/publishData') ?>',
          type: 'POST',
          data: data,
          ...
          success: function(){
            ...
            $('#view').load('<?= base_url('index.php/admin/publishData') ?>');
          }
        });
      });
