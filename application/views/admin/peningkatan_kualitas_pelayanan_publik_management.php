...
<link href="<?= base_url('assets/gentelella-master') ?>/vendors/bootstrap-imageupload/css/fileinput.min.css" rel="stylesheet">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                  ...
                  <div class="x_content">
                    ...
                    <?= form_open('admin/peningkatan-kualitas-pelayanan-publik-management') ?>
                    ...
                    <?= form_open_multipart('admin/peningkatan-kualitas-pelayanan-publik-management',array('class' => 'form-horizontal')) ?>
    ...
    function retrieveData(id_peningkatan_kualitas_pelayanan_publik) {
        $.get('<?= base_url('index.php/admin/peningkatan-kualitas-pelayanan-publik-management') ?>' + '/' + id_peningkatan_kualitas_pelayanan_publik, function(data) {
