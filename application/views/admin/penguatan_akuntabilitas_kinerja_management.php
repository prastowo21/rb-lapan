...
<link href="<?= base_url('assets/gentelella-master') ?>/vendors/bootstrap-imageupload/css/fileinput.min.css" rel="stylesheet">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                  ...
                  <div class="x_content">
                    ...
                    <?= form_open('admin/penguatan-akuntabilitas-kinerja-management') ?>
                    ...
                    <?= form_open_multipart('admin/penguatan-akuntabilitas-kinerja-management',array('class' => 'form-horizontal')) ?>
    ...
    function retrieveData(id_penguatan_akuntabilitas_kinerja) {
        $.get('<?= base_url('index.php/admin/penguatan-akuntabilitas-kinerja-management') ?>' + '/' + id_penguatan_akuntabilitas_kinerja, function(data) {
