...
<link href="<?= base_url('assets/gentelella-master') ?>/vendors/bootstrap-imageupload/css/fileinput.min.css" rel="stylesheet">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                  ...
                  <div class="x_content">
                    ...
                    <?= form_open('admin/penataan-tatalaksana-management') ?>
                    ...
                    <?= form_open_multipart('admin/penataan-tatalaksana-management',array('class' => 'form-horizontal')) ?>
    ...
    function retrieveData(id_penataan_tatalaksana) {
        $.get('<?= base_url('index.php/admin/penataan-tatalaksana-management') ?>' + '/' + id_penataan_tatalaksana, function(data) {
