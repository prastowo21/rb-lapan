...
<link href="<?= base_url('assets/gentelella-master') ?>/vendors/datatables.net-scroller-bs/css/scroller.bootstrap.min.css" rel="stylesheet">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                  ...
                  <div class="x_content">
                    ...
                    <?= form_open('admin/kebijakan-management') ?>
                    ...
                    <?= form_open('admin/kebijakan-management',array('class' => 'form-horizontal')) ?>
    ...
    function retrieveData(id_kebijakan) {
        $.get('<?= base_url('index.php/admin/kebijakan-management') ?>' + '/' + id_kebijakan, function(data) {
