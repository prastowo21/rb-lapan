...
<link href="<?= base_url('assets/css') ?>/ekko-lightbox.css" rel="stylesheet">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                  ...
                  <div class="x_content">
                    ...
                    <?= form_open('admin/buletin-management') ?>
                    ...
                    <?= form_open_multipart('admin/buletin-management',array('class' => 'form-horizontal')) ?>
    ...
    $(document).ready(function() {
        ...
        $("#cover").fileinput({
          uploadUrl: '<?= base_url('index.php/admin/coverUploader') ?>',
        ...
        $("#cover_baru").fileinput({
          uploadUrl: '<?= base_url('index.php/admin/coverEditUploader') ?>',
          overwriteInitial: true,
          autoReplace: true,
          showUploadedThumbs: false,
          maxFileSize: 500,
        ...
        $("#dokumen").fileinput({
          uploadUrl: '<?= base_url('index.php/admin/dokumenUploader') ?>',
          overwriteInitial: true,
          autoReplace: true,
          showUploadedThumbs: false,
          maxFileSize: 99999,
        ...
        $("#dokumen_baru").fileinput({
          uploadUrl: '<?= base_url('index.php/admin/dokumenEditUploader') ?>',
          overwriteInitial: true,
          autoReplace: true,
          showUploadedThumbs: false,
          maxFileSize: 99999,
    ...
    function retrieveData(id_buletin) {
        $.get('<?= base_url('index.php/admin/buletin-management') ?>' + '/' + id_buletin, function(data) {
