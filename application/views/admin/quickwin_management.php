...
<link href="<?= base_url('assets/gentelella-master') ?>/vendors/bootstrap-imageupload/css/fileinput.min.css" rel="stylesheet">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                  ...
                  <div class="x_content">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                      <div class="x_panel">
                        <div class="x_title">
                          <h2>Profile Management <small>Quickwins</small></h2>
                    ...
                    <?= form_open('admin/quickwin-management') ?>
                    ...
                    <?= form_open_multipart('admin/quickwin-management',array('class' => 'form-horizontal')) ?>
    ...
    function retrieveData(id_quickwin) {
        $.get('<?= base_url('index.php/admin/quickwin-management') ?>' + '/' + id_quickwin, function(data) {
