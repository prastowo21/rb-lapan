  ...
  <div class="clearfix"></div>
      <?= $this->session->flashdata('msg') ?>
        <div class="col-md-12 col-sm-12 col-xs-12">
          <div class="x_panel">
            <div class="x_title">
              <h2>User Management <small>Admin</small></h2>
              ...
              <table id="datatable" class="table table-striped table-bordered">
                ...
                <?php foreach ($pengguna as $user): ?>
                  ...
                  <tr>
                    <td><?= $No++; ?></td>
                    <td><?= $user->id_user ?></td>
                    <td><?= $this->admin_m->get_row(array('id_user' => $user->id_user))->nama ?>
                    <td><?= $this->admin_m->get_row(array('id_user' => $user->id_user))->email ?>
                    <td><?= $this->admin_m->get_row(array('id_user' => $user->id_user))->telepon ?>
                    <td>
        ...
        <?= form_open('admin/admin-management/') ?>
        ...
        <?= form_open_multipart('admin/admin-management',array('class' => 'form-horizontal')) ?>
              ...
              <div class="modal-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    ...
                    <div class="checkbox">
                      <label>
                        <input type="checkbox" name="add_user" id="add_user" />User Management
                      </label>
                    </div>
                    <div class="checkbox">
                      <label>
        ...
        <?= form_open('admin/admin-management',array('class' => 'form-horizontal')) ?>
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
  ...
  function deleteUser(id_user){
   ...
   function retrievePrivilege(id_user){
      $.get('<?= base_url('index.php/admin/editor-management') ?>' + '/' + id_user, function(data) {
        ...
        if(data.user == "on"){
          $('#chg_user').prop('checked', true);
        }else{
          $('#chg_user').prop('checked', false);
        }
        if(data.banner == "on"){
